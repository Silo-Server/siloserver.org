...
These steps use the web player. Provider search and AI actions depend on
services the administrator has configured and limits on your account.

## Search online

1. Start the correct movie or episode version and open its subtitle menu.
2. Select **Search Online…**, choose a language, and select **Search**.
3. Choose a result that matches your release. Wait for the download to finish.
4. Reopen the subtitle list and select the saved track. Check a few lines
...
In the same **Add Subtitles** dialog, choose your subtitle file, check the
...
1. Open **Translate with AI…** in the subtitle menu.
...
Text or audio may be sent to the administrator's chosen AI provider. Generation
...
provider configuration. Ask the administrator to check the failed job.
