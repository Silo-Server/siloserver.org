...
User DB
: Reserved for Litestream user database replication in the current admin UI.
...
- Public/private/user DB storage tabs and recommendation text: [`StorageSettings.tsx`](https://github.com/Silo-Server/silo-server/blob/main/web/src/pages/admin-settings/StorageSettings.tsx#L140-L165) and [`StorageSettings.tsx`](https://github.com/Silo-Server/silo-server/blob/main/web/src/pages/admin-settings/StorageSettings.tsx#L215-L323).
