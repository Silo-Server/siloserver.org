...
- Silo filesystem roots: [`docker-compose.yml`](https://github.com/Silo-Server/silo-server/blob/main/docker-compose.yml), [`.env.example`](https://github.com/Silo-Server/silo-server/blob/main/.env.example), [`filesystem.go`](https://github.com/Silo-Server/silo-server/blob/main/internal/api/handlers/filesystem.go#L26-L34).
